...
struct Logic {
    static func SwitchOnCSTHBP(CS: String?, Data1: inout [Bool], Data2: [UIButton]) {
    ...
    static func SwitchOnV1AndV2AsInt(Val1: Any?, Val2: Any?, Data1: inout [Bool], Data2: [UIButton]) {
